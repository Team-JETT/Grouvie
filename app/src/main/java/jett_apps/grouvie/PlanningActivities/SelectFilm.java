...
//                    Intent cinemaIntent = new Intent(view.getContext(), SelectCinema.class);
                    Intent cinemaIntent = new Intent(view.getContext(), CinemaLocations.class);
    ...
    private JSONObject getLocalData() {
        ...
        try {
            String postcode = ProfileManager.getPostcode(SelectFilm.this);

            //Remove spaces
            postcode = postcode.replaceAll("\\s+","");

            json.accumulate("postcode", postcode);
